                  ...
                  {stock.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-medium flex items-center gap-1 ${status.color}`}
                          >
                            <StatusIcon size={14} />
                            {status.status}
                          </span>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm text-red-600">
                          {isExpiredItem
                            ? "Blood units have expired"
                            : status.status === "critical"
                              ? "Blood expiring within 3 days"
                              : "Very low stock level"}
                        </span>
                      </div>
                      <div className="text-sm text-red-600">
                        {item.quantity} units • Expires{" "}
                        {new Date(item.expiryDate).toLocaleDateString()}
                      </div>
                    </div>
                  );
