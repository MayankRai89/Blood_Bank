      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="bg-white/90 backdrop-blur-md shadow-2xl rounded-2xl p-8 w-full max-w-md border border-gray-100 transition-all">
          ...
          <div className="flex flex-col items-center mb-5 gap-2">
            <div id="googleBtnContainer" className="flex justify-center w-full min-h-[44px]"></div>
            <button
              type="button"
              onClick={handleGoogleFallback}
              disabled={loading}
              className="w-full py-2.5 bg-white border border-gray-300 rounded-xl font-semibold text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition shadow-sm flex items-center justify-center gap-3 text-xs disabled:opacity-50"
            >
